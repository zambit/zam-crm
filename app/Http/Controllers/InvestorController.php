...
//    public function addToWl(AddToWlRequest $request)
    public function addToWl(Request $request, AmoCrmManager $amocrm, Client $client)
    {
        //TODO Catch errors
//        try {
            $data = $request->all();
            ...
            $client->request('POST', 'https://hooks.zapier.com/hooks/catch/3624585/gf14c4/', [
                'form_params' => ['email' => $person->email]
            ]);
